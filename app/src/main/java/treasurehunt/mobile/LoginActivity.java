...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        // Check for a valid password, if the friend entered one.
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                // Retrieve data rows for the device friend's 'profile' contact.
                ...
                // a primary email address if the friend hasn't specified one.
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            User u = Database.getUserByUsername(mEmail);
            if (u == null) u = Database.getUserByEmail(mEmail);
            if(u == null) {
                return false;
            }

            if(u.getPassword().equals(mPassword)) return true;
